...
public class GenerationSettings
{
    ...
    [SerializeField] public double rep_pen = 1.06f;
    [SerializeField] public int rep_pen_range = 1600;
    [SerializeField] public double rep_pen_slope = 0.9f;
    [SerializeField] public double temperature = 0.69f;
    [SerializeField] public double tfs = 1f; //Tail Free Sampling
    [SerializeField] public double top_a = 0.0f; //Top A Sampling
    [SerializeField] public double top_k = 0.0f; // Top K Sampling
    [SerializeField] public double top_p = 0.69f; //Top P Sampling
    [SerializeField] public double typical = 1.0f; //typical sampling
